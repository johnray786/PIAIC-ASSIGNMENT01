...
var alien_colors = ["Red", "Green", "Blue"];
for (var c = 0; c < alien_colors.length; c++) {
...
var alien_colors1 = ["Green", "Yellow", "Red"];
for (var d = 0; d < alien_colors1.length; d++) {
...
var stageOfLifePrevious;
for (var age = 0; age <= 65; age++) {
    var stageOfLife = void 0;
    if (age < 2) {
        stageOfLife = "Baby";
    }
    else if (age < 4) {
    ...
    if (age === 0 || stageOfLife !== stageOfLifePrevious) {
        console.log("From Age ".concat(age, " Stage Of Life is ").concat(stageOfLife, "."));
